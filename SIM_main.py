...
def main():
    ...
    parser. add_argument("--data_dir", default=None, type=str, required=True,
                        help-"Data file directory, because when there is train.text dev.text")
    ...
    parser. add_argument("--model_config", default=None, type=str, required=True,
                        help-"Model profile jason file")
    parser. add_argument("--pre_train_model", default=None, type=str, required=True,
                        help-"Pretrained model file, parameter matrix. Load if it exists)
    parser. add_argument("--output_dir", default=None, type=str, required=True,
                        help-"File with output results")

    # Other parameters
    parser. add_argument("--max_seq_length", default=128, type=int,
                        help:"The maximum length entered into bert should generally not exceed 512")
    parser. add_argument("--do_train", action='store_true',
                        help-"Trained or not")
    parser. add_argument("--train_batch_size", default=8, type=int,
                        help. .. ""The batch_size set")
    parser. add_argument("--eval_batch_size", default=8, type=int,
                        help.batch_size set)
    parser. add_argument('--gradient_accumulation_steps', type=int, default=1,
                        help-"Steps for cumulative gradient updates to compensate for situations in which the GPU is too small")
    parser. add_argument("--learning_rate", default=5e-5, type=float,
                        help-"Learning rate")
    parser. add_argument("--weight_decay", default=0.0, type=float,
                        help-"Weight attenuation")
    parser. add_argument("--adam_epsilon", default=1e-8, type=float,
                        help="Epsilon for Adam optimizer.")
    parser. add_argument("--max_grad_norm", default=1.0, type=float,
                        help-"Maximum gradient update")
    parser. add_argument("--num_train_epochs", default=3.0, type=float,
                        helps"epoch number")
    parser. add_argument('--seed', type=int, default=42,
                        help="random seed for initialization")
    parser. add_argument("--warmup_steps", default=0, type=int,
                        help-"Let learning increase to 1 steps, after warmup_steps, then decay to 0")
