...
Only three types of projects need to be identified in this project
Here's the following test, the first LABELS, "O", "B-LOC," "I-LOC", because there are only three that need to be predicted.
#ρ ρ LABELS = ["O", "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X", "[CLS]", "[SEP]"]
...
def statistical_real_sentences(input_ids:torch. Tensor,mask:torch. Tensor,predict:list)-> list:
    ...
    The 0th place is the last one of the "CLS" is the "lt;pad" or "SEP"
